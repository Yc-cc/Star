<template>
    <div class="pages">
        <div v-show="!showLogin" class="welcome">
            <div class="title">
                <span>星外卖</span>
                <em>{{welText}}</em>
            </div>
        ...
        <div v-show="showLogin" class="body">
            <van-sticky>
                ...
                <HeaderTop :title="city">
                    <div class="mess" @click="mapShow" slot="left">
                        <em class="city">{{city}}</em>
                        <em class="temperat">{{briefNew}} {{tmpNew}}℃</em>
                    </div>
                    <div class="tool" slot="right">
                        <div class="say" @click="backLogin"></div>
                        <div class="add"></div>
                    </div>
                </HeaderTop>
            ...
            <div class="mainBox">
                ...
                <div v-if="mapBlooean" id="container" class="allmap"></div>
                <div class="mainPart">
                    <div class="swiper">
        ...
        <div v-if="!bottomTitle" class="right-info">&copy; 2021- yc copy right</div>
    </div>
